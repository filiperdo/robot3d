	...
	<div class="col-lg-12">
		...
		<div class="row">
			...
			<div class="col-lg-2 col-md-2">
				<a href="<?php echo URL;?>newsletter/form" class="btn btn-success">Cadastrar <?php echo $this->title; ?></a>
			</div>
		</div>
	</div>
</div>
...
<table class="table table-striped sortable table-condensed">
	...
	<tr>
		...
		<td align="right">
			<a href="<?php echo URL;?>newsletter/form/<?php echo $newsletter->getId_newsletter();?>" class="btn btn-info btn-sm"><i class="glyphicon glyphicon-pencil"></i></a>
