...
<!-- /.row -->
<form id="form1" name="form1" method="post" action="<?php echo URL;?>newsletter/<?php echo $this->action;?>/">
...
<div class="form-group">
	<label for="id_newsletter">Id_newsletter</label> 
		<input type="text" name="id_newsletter" id="id_newsletter"  class="form-control" required="required" value="<?=$this->obj->getId_newsletter()?>" />
</div>
