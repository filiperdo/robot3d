		...
		<div class="row">
			<div class="col-lg-6 col-md-6">
				<ol class="breadcrumb">
					...
					<li class="active"><a href="<?php echo URL;?>follow"><?php echo $this->title; ?></a></li>
				</ol>
			</div>
			<div class="col-lg-4 col-md-3">
			<form name="form-search" action="<?php echo URL;?>follow" method="post">
			...
			<div class="col-lg-2 col-md-2">
				<a href="<?php echo URL;?>follow/form" class="btn btn-success">Cadastrar <?php echo $this->title; ?></a>
			</div>
		</div>
	</div>
</div>
