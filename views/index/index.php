  ...
  <div class="by">
    <div class="or">
      ...
      <a class="e" href="index.html">
        <!-- <img src="public/img/brand-white2.png" alt="brand">  -->
      </a>
    </div>
          ...
          <div class="qg">
            ...
            <div class="any" data-grid="images">
              <div style="display: none">
                <img data-action="zoom" data-width="1050" data-height="700" src="<?php echo URL; ?>public/img/unsplash_1.jpg">
              </div>

              <div style="display: none">
                <img data-action="zoom" data-width="640" data-height="640" src="<?php echo URL; ?>public/img/instagram_1.jpg">
              </div>

              <div style="display: none">
                <img data-action="zoom" data-width="640" data-height="640" src="<?php echo URL; ?>public/img/instagram_13.jpg">
              </div>

              <div style="display: none">
                <img data-action="zoom" data-width="1048" data-height="700" src="<?php echo URL; ?>public/img/unsplash_2.jpg">
              </div>
            </div>
