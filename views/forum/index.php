	  ...
	  <div class="panel-body">
		    ...
		    <div class="row" style="padding: 10px 0; <?php echo $class_border; ?>">
		    	<div class="col-md-10">
			    	...
			    	<small>Último post: <?php echo Data::timeAgo( $objItem->getDate() );?> | por <a href="<?php echo URL.'user/dashboard/'.$objItem->getUser()->getLogin()?>"> <?php echo $objItem->getUser()->getLogin();?></a> </small>
			    	<?php } ?>
		    	</div>
